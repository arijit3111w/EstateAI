...
import CurrentPrimeRate from "@/components/CurrentPrimeRate";

// --- (1) IMPORT THE NEW COMPONENT ---
import LoanSuggestions, {
  Bank, // <-- Import the Bank type
} from "@/components/LoanSuggestions"; // <-- Make sure path is correct

// --- (2) DEFINE NEW, RICHER BANK DATA ---
// We define the type as Bank[] which we will export from LoanSuggestions
const CANADIAN_BANKS: Bank[] = [
  {
    name: "RBC Royal Bank",
    link: "https://www.rbcroyalbank.com/mortgages/",
    logoFallback: "R",
    description: "Canada's largest bank, offering a wide range of mortgage options.",
  },
  {
    name: "TD Bank",
    link: "https://www.td.com/ca/en/personal-banking/products/mortgages",
    logoFallback: "T",
    description: "Known for flexible mortgage features and convenient hours.",
  },
  {
    name: "Scotiabank",
    link: "https://www.scotiabank.com/ca/en/personal/advice-plus/mortgages.html",
    logoFallback: "S",
    description: "Strong international presence with diverse mortgage solutions.",
  },
  {
    name: "BMO",
    link: "https://www.bmo.com/main/personal/mortgages/",
    logoFallback: "B",
    description: "Canada's oldest bank, providing various fixed and variable rates.",
  },
  {
    name: "CIBC",
    link: "https://www.cibc.com/en/personal-banking/mortgages.html",
    logoFallback: "C",
    description: "Offers cash-back mortgages and flexible payment options.",
  },
  {
    name: "National Bank",
    link: "https://www.nbc.ca/personal/mortgages.html",
    logoFallback: "N",
    description: "A leading bank in Quebec, offering competitive rates.",
  },
];
...
const Analytics = () => {
  ...
  const handlePropertySelect = (property: any) => {
    ...
    const estimatedMonthlyRent =
      Math.round(
        (property.price * baseRentPercent * areaMultiplier * gradeMultiplier) /
          100
  ...
  const calculateEMI = () => {
    ...
    // Add check for rate > 0 to prevent division by zero or NaN
    if (rate <= 0 || tenure <= 0 || principal <= 0) {
      return 0;
    }
  ...
  const totalInterest =
    emi > 0 ? emi * loanTenure * 12 - loanAmount : 0;
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden">
          <div className="h-64 md:h-72 lg:h-80">
            ...
            />
            <div
              className="absolute inset-0 bg-gradient-to-r from-blue-900/80 via-blue-800/70 to-blue-700/60"
              aria-hidden="true"
            />
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-semibold">
                    {t("analytics.currentlyAnalyzing")}
                  </h4>
                  <p className="text-blue-100 text-sm">
                    {t("analytics.propertyNumber")} #
                    {relatedHouses.findIndex(
                      (h) => h.id === selectedProperty.id
                    ) + 1}{" "}
                    •{selectedProperty.bedrooms}BR/{selectedProperty.bathrooms}
                    BA •{selectedProperty.living_area.toLocaleString()}{" "}
                    {t("analytics.sqft")} •{t("analytics.grade")}{" "}
                    {selectedProperty.grade}
                  </p>
                </div>
                <div className="text-right">
                  <div className="text-2xl font-bold">
                    ${(selectedProperty.price / 1000).toFixed(0)}K CAD
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
...
                {t("analytics.projectionBased")}
              </div>
            </Card> */}
            <Card className="p-4 md:p-5">
              <div className="flex items-center justify-between">
                <span className="text-sm text-muted-foreground">
                  {t("analytics.rentalYield")}
                </span>
              ...
              <div className="text-xs text-muted-foreground">
                {t("analytics.annualRentVs")}
              </div>
            </Card>
            <Card className="p-4 md:p-5">
              <div className="flex items-center justify-between">
                <span className="text-sm text-muted-foreground">
                  {t("analytics.monthlyEmi")}
                </span>
                <DollarSign
              ...
              <div className="text-xs text-muted-foreground">
                {t("analytics.basedOnRateAndTenure")}
              </div>
            </Card>
            ...
            <Card className="p-4 md:p-5">
              ...
              <div className="text-xs text-muted-foreground">
                {t("analytics.overFullLoanTenure")}
              </div>
            </Card>
            <CurrentPrimeRate />
          </div>
        ...
        <section className="container mx-auto px-4 py-8 md:py-12">
          <Tabs defaultValue="roi" className="space-y-6 md:space-y-8">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="text-lg md:text-xl font-semibold">
                            {t("analytics.investmentCalculator")}
                          </h3>
                          <p className="text-sm text-muted-foreground">
                            {t("analytics.configureInvestmentParameters")}
                          </p>
                        </div>
                      </div>
                      {selectedProperty && (
                    ...
                    <div className="flex items-start justify-between gap-2 mb-6">
                      <div>
                        ...
                        <p className="text-sm text-blue-100">
                          Future value growth based on appreciation
                        </p>
                      </div>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      ...
                      <div className="p-4 rounded-lg bg-white/10 backdrop-blur-sm">
                        ...
                        <div className="text-2xl font-bold text-white">
                          ${((monthlyRent * 12 * 10) / 100000).toFixed(2)}L
                        </div>
                      </div>
                    </div>
            ...
            <TabsContent value="emi">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="p-3 rounded-lg bg-green-50 dark:bg-green-900/20 text-center">
                        ...
                        <div className="font-semibold text-green-700 dark:text-green-300">
                          $
                          {((loanAmount + totalInterest) / 100000).toFixed(
                            1
                          )}
                          L
                        </div>
              ...
              {/* --- (3) ADD THE NEW COMPONENT HERE --- */}
              <div className="mt-6 md:mt-8">
                <LoanSuggestions banks={CANADIAN_BANKS} t={t} />
              </div>
            </TabsContent>
